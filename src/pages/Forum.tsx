...
import { LCARSPageFrame, LCARSPanel } from "@/components/lcars";
...
const Forum: React.FC = () => {
  ...
  const { data: allThreads = [], isLoading: threadsLoading } =
    useForumThreads();
                      ...
                      >
                        ...
                        >
                          ...
                          <p className="text-sm text-muted-foreground mb-6">
                            Sign in to create threads and participate in
                            discussions
                          </p>
                          <Link to="/auth">
                            <Button className="rounded-r-full rounded-l-none border-l-4 border-l-accent bg-accent/20 hover:bg-accent/30 text-foreground min-h-[48px] px-6">
                      ...
                      <AnnouncementsSection
                        ...
                        renderThread={(thread) => (
                          <ThreadCardWithLike
                            key={thread.id}
                            thread={thread}
                            isBookmarked={bookmarkedThreadIds.includes(
                              thread.id,
                            )}
                          />
                        )}
                ...
                >
                  ...
                  >
                    <div className="space-y-3 text-sm p-4">
                      <div
                        className="flex items-center justify-between p-2 bg-background/40 rounded-r-lg"
...
const ThreadCardWithLike: React.FC<{ thread: any; isBookmarked: boolean }> = ({
  thread,
  isBookmarked,
}) => {
