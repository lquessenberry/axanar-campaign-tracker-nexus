...
import { Calendar, DollarSign, Package, Search, Users } from "lucide-react";
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4">
            <div className="text-center">
              ...
              <p className="text-xl text-axanar-silver max-w-3xl mx-auto mb-8">
                Discover and support the projects that are building the future
                of the Axanar universe. From films to merchandise, every
                campaign helps bring our vision to life.
              </p>
              ...
              <div className="flex flex-col md:flex-row gap-4 max-w-2xl mx-auto">
                ...
                >
                  ...
                  <option value="current_amount" className="text-black">
                    Most Funded
                  </option>
                  <option value="backers_count" className="text-black">
                    Most Backers
                  </option>
        ...
        {/* Stats Overview */}
        <section data-tour="campaign-stats" className="py-8 bg-muted/30">
          <div className="container mx-auto px-4">
            <div className="grid grid-cols-1 md:grid-cols-3 gap-6">
              ...
              <Card>
                ...
                <CardContent>
                  <div className="text-2xl font-bold">
                    {filteredCampaigns
                      .reduce((sum, c) => sum + c.backers_count, 0)
                      .toLocaleString()}
                  </div>
                  <p className="text-xs text-muted-foreground">
