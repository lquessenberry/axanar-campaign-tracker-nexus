      ...
      items: [
        {
          ...
          description:
            "Access your existing donor account in our new platform using your email address.",
          details: [
        ...
        },
        {
          ...
          description:
            "Verify and update your contact information and preferences.",
          details: [
        ...
        },
        {
          ...
          description:
            "Check the details of your previous donations and associated rewards.",
          details: [
        ...
        },
        {
          ...
          description:
            "Connect with our admin team for any assistance with your account or pledges.",
          details: [
            ...
            "Check our <Link to='/faq' className='text-axanar-teal hover:underline'>FAQ page</Link> for common questions before contacting support",
          ],
        },
      ],
    },
      ...
      items: [
        {
          ...
          description:
            "Your donor information is now protected with improved security measures.",
          details: [
        ...
        },
        {
          ...
          description:
            "Our new system is significantly faster than the previous Laravel/Artisan platform.",
          details: [
        ...
        },
        {
          ...
          description:
            "Professional administrators available to help with account recovery and updates.",
          details: [
      ...
      items: [
        {
          ...
          description:
            "Understanding the technical reasons behind our platform migration. See our <Link to='/faq' className='text-axanar-teal hover:underline'>FAQ</Link> for more migration details.",
          details: [
        ...
        },
        {
          ...
          description:
            "Complete information about what donor data was preserved during migration.",
          details: [
        ...
        },
        {
          ...
          description:
            "Exciting new capabilities available in our migrated platform.",
          details: [
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
        ...
        >
          <section
            className="relative min-h-[60vh] w-[100vw] flex items-center justify-center text-white py-24 overflow-hidden"
            onPointerMove={(e) => {
          ...
          >
            ...
            <div className="absolute inset-0 z-0">
              ...
              >
                <source
                  src="https://vsarkftwkontkfcodbyk.supabase.co/storage/v1/object/public/backgrounds/grok-video-80a043e4-3217-40ac-b41f-10c6cd2d9e4c(1).mp4"
                  type="video/mp4"
                />
              </video>
            ...
            <div className="container mx-auto px-4 text-center relative z-10 max-w-5xl">
              ...
              >
                We&apos;ve migrated from our old Laravel/Artisan platform to
                this new system. Learn how to recover and manage your existing
                donor account. Check our{" "}
                <Link
                  to="/faq"
                  className="text-white hover:text-axanar-teal underline transition-colors"
                >
                  FAQ
                </Link>{" "}
        ...
        >
          <div className="container mx-auto px-4">
            <HowItWorksSteps sections={howItWorksSections} />
            ...
            <div className="my-16 py-8">
              <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center justify-center">
                ...
                <div className="aspect-video rounded-lg overflow-hidden border border-primary/20"></div>
              </div>
            </div>
            <AxanarCTA
