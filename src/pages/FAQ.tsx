      ...
      items: [
        {
          ...
          question:
            "Which campaigns are currently integrated into the platform?",
          answer:
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Axanar Productions continues work on the Axanar series. For the most up-to-date information on current productions and releases, please visit our official website or social media channels.",
        },
        {
          id: "axanar-funding",
    ...
    },
    {
      ...
      items: [
        ...
        },
        {
          ...
          answer:
            "Click on the 'Login' button and select 'Recover Account'. Enter the email address you used for your original donation. You'll receive instructions to verify your identity and set up a new password for the migrated platform. For a detailed step-by-step guide, visit our <Link to='/how-it-works' className='text-axanar-teal hover:underline'>How It Works page</Link>.",
        },
        {
          id: "data-preservation",
          question: "Is my donation history and reward information preserved?",
          answer:
            "Yes, we've migrated all donor information including your pledge history, reward entitlements, and shipping details from the previous system. Please verify this information after recovering your account to ensure everything is accurate.",
        },
        {
          id: "address-update",
          question: "What if my shipping address needs to be updated?",
          answer:
            "After recovering your account, you can update your profile information, including your shipping address. Having accurate shipping information is essential for us to deliver any physical rewards you're entitled to receive.",
        },
        {
          id: "email-recovery",
          question:
            "What if I can't remember what email I used for my donation?",
          answer:
      ...
      items: [
        {
          id: "recovery-trouble",
          question:
            "I'm having trouble recovering my account. What should I do?",
          answer:
            "If you're experiencing difficulties recovering your account, first make sure you're using the correct email address that you used for your original donation. If problems persist, please contact our admin team through the <Link to='/support' className='text-axanar-teal hover:underline'>Support page</Link> for personalized assistance. For detailed recovery instructions, see our <Link to='/how-it-works' className='text-axanar-teal hover:underline'>How It Works page</Link>.",
        },
        {
          id: "platform-security",
          question: "Is the new platform secure?",
          answer:
            "Yes, our new platform implements modern security practices to protect your data. We've significantly improved security compared to our previous Laravel/Artisan system, including better encryption, secure authentication methods, and regular security updates.",
        },
        {
          id: "mobile-support",
          question: "Can I use the platform on mobile devices?",
          answer:
            "Yes, our new platform is fully responsive and optimized for mobile devices. You can recover your account, update your information, and view your pledge history from your smartphone or tablet.",
        },
        {
          id: "migrated-data",
          question: "What data was migrated from the old system?",
          answer:
            "We migrated all essential donor information including your name, email, contact details, pledge history, reward entitlements, and shipping preferences. Some peripheral data like comment history might not have been transferred if it wasn't relevant to your donor status.",
        },
      ],
    },
  ];
  ...
  return (
    <div className="min-h-screen flex flex-col">
      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-4 text-center relative z-10 max-w-5xl">
            ...
            >
              ...
              <span
                ...
                style={{
                  textShadow:
                    "0 0 20px rgba(255, 255, 255, 0.6), 0 0 40px rgba(255, 255, 255, 0.3), 0 0 60px rgba(255, 255, 255, 0.2)",
            ...
            <p
              className="text-xl md:text-2xl text-white max-w-4xl mx-auto leading-relaxed drop-shadow-2xl"
              style={{
                textShadow:
                  "0 0 20px rgba(255, 255, 255, 0.8), 0 0 40px rgba(255, 255, 255, 0.4), 0 4px 8px rgba(0, 0, 0, 0.8)",
              }}
            >
              Find answers about our platform migration and how existing donors
              can recover their accounts.
            </p>
          </div>
        ...
        >
          <div className="container mx-auto px-4">
            <FAQAccordion sections={[faqSections[1]]} sectionVariant="accent" />
          </div>
        </GradientSection>
        ...
        >
          <div className="container mx-auto px-4">
            <FAQAccordion sections={[faqSections[3]]} sectionVariant="muted" />
          </div>
        </GradientSection>
            ...
            <div className="max-w-4xl mx-auto">
              <div className="mb-16 text-center">
                ...
                <p className="text-xl text-muted-foreground max-w-2xl mx-auto">
                  Our team is here to help with any questions about your account
                  recovery or the platform.
                </p>
              </div>
              <ContactForm />
