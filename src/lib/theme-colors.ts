...
export const THEME_COLOR_TOKENS: Record<string, ThemeColorTokens> = {
  ...
  'defiant-2371': {
    ...
    card: '260 20% 12%',
    cardForeground: '260 60% 88%',
    popover: '260 20% 12%',
    popoverForeground: '260 60% 88%',
    primary: '260 80% 65%',
    primaryForeground: '0 0% 100%',
    ...
    secondaryForeground: '0 0% 0%',
    accent: '260 20% 18%',
    accentForeground: '260 60% 88%',
    muted: '260 20% 18%',
    mutedForeground: '280 60% 78%',
    destructive: '0 70% 55%',
    destructiveForeground: '0 0% 100%',
    border: '260 30% 30%',
    input: '260 20% 15%',
