...
export function ProfileSidebarNav({ 
  ...
  return (
    <div className="relative">
      ...
      <Sidebar 
        collapsible="icon"
        className={`${isCollapsed ? "w-20" : "w-56 lg:w-64"} pt-24 lg:pt-28 ml-2 lg:ml-4 mr-1 lg:mr-2 mb-4 border-l-4 border-primary bg-muted/30 backdrop-blur-sm shadow-lg`}
      >
