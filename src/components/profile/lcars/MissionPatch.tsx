...
export const MissionPatch: React.FC<MissionPatchProps> = ({
  ...
  return (
    ...
    >
      {/* Gold Top Banner */}
      <div 
        className="bg-[#F9D71C] border-b-4 border-black flex items-center justify-center"
        style={{ height: `${bannerHeight}px` }}
      >
        <h2 
          className="font-sans font-bold tracking-tight text-black"
          style={{ fontSize: `${bannerFontSize}px` }}
        >
      ...
      <div 
        className="relative flex-1 bg-[#1C2526] flex flex-col items-center justify-center px-8"
        style={{
      ...
      >
        ...
        <div 
          className="rounded-full bg-white border-black flex items-center justify-center relative"
          style={{
            width: `${circleSize}px`,
        ...
        {/* Donor Name */}
        <div 
          className="text-[#E8E8E0] font-bold tracking-wide text-center px-4" 
          style={{ 
      ...
      {/* Orange Bottom Strip */}
      <div 
        className="bg-[#FF6A00] flex items-center justify-center"
