    ...
    <div className="flex flex-col items-center justify-center text-center w-full px-2 md:px-4">
      ...
      <div className="flex flex-col sm:flex-row justify-center gap-2 md:gap-3">
        <Button 
          ...
          className="bg-axanar-teal hover:bg-axanar-teal/90 h-8 md:h-10 lg:h-12 px-4 md:px-6 lg:px-8 shadow-lg text-xs md:text-sm lg:text-base disabled:opacity-50"
        >
