...
const MainAuthForm = ({
  ...
  return (
    <ConsoleGlitch alertLevel={alertLevel} isActive={isAlertActive}>
              ...
              <div className="space-y-4">
                <div className="text-center p-4 bg-muted rounded-md">
                  <p className="text-sm text-muted-foreground">
                    This is an invite-only platform. Check if you already have
                    an account or if you're eligible to create one.
                  </p>
                </div>
