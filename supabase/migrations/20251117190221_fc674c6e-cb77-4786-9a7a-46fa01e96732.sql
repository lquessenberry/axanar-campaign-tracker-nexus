...
-- Make get_leaderboard a SECURITY DEFINER function to bypass RLS for public leaderboard viewing
  ...
  WITH ranked_data AS (
    SELECT 
      ...
      CASE p_category
        ...
        WHEN 'total_donated' THEN COALESCE(cl.total_donated, 0)::NUMERIC
...
COMMENT ON FUNCTION public.get_leaderboard IS 'General leaderboard function supporting multiple categories - uses SECURITY DEFINER to allow public access';
