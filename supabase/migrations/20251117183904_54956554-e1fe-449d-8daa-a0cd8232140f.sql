-- Fix forum activity leaderboard - query achievements directly instead of from view
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE((SELECT COUNT(*) FROM user_achievements ua WHERE ua.user_id = p.id), 0)::INTEGER as achievements,
