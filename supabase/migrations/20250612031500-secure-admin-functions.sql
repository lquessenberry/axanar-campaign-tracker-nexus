...
-- Add security check to get_admin_users function
...
-- Create a secure function for adding admins
...
-- Create a secure function for removing admins
...
-- Create a secure function for updating admin roles
