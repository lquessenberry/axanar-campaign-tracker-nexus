-- Make get_forum_activity_leaderboard a SECURITY DEFINER function to bypass RLS
DROP FUNCTION IF EXISTS public.get_forum_activity_leaderboard(p_limit text);
...
BEGIN
  ...
  SELECT 
    ...
    COALESCE(cl.achievement_count, 0)::INTEGER as achievements,
...
COMMENT ON FUNCTION public.get_forum_activity_leaderboard IS 'Forum activity leaderboard - uses SECURITY DEFINER to allow public access';
